...
public class ServerTest extends Server {
    ...
    RSPEngine engine = new RSPEngine("csparql", "http://localhost");

    public static void main(String[] args) {
        new ServerTest().start(new RSPEngine("csparql", "http://localhost"), "/Users/riccardo/_Projects/RSP/rspservices2/src/testTask/resources/testconfig.properties");
