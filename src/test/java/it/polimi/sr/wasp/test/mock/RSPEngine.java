...
import it.polimi.sr.wasp.test.mock.features.queries.QueriesGetterFeature;
import it.polimi.sr.wasp.test.mock.features.queries.QueryDeletionFeature;
import it.polimi.sr.wasp.test.mock.features.queries.QueryGetterFeature;
import it.polimi.sr.wasp.test.mock.features.queries.QueryRegistrationFeature;
import it.polimi.sr.wasp.test.mock.features.streams.StreamDeletionFeature;
import it.polimi.sr.wasp.test.mock.features.streams.StreamGetterFeature;
import it.polimi.sr.wasp.test.mock.features.streams.StreamRegistrationFeature;
import it.polimi.sr.wasp.test.mock.features.streams.StreamsGetterFeature;
import it.polimi.sr.wasp.test.mock.model.EmptyTask;
...
public class RSPEngine implements QueryRegistrationFeature, QueryDeletionFeature, QueryGetterFeature, QueriesGetterFeature, StreamRegistrationFeature, StreamGetterFeature, StreamsGetterFeature, StreamDeletionFeature {
