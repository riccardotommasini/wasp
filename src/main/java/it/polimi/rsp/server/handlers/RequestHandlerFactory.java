...
public class RequestHandlerFactory {
    ...
    private static <T> Optional<T> getObject(it.polimi.rsp.server.model.Key key, Class<?> t) {
        if (Stream.class.isAssignableFrom(t)) {
    ...
    private static Object deleteObject(it.polimi.rsp.server.model.Key key, Class<?> t) {
        if (Stream.class.isAssignableFrom(t)) {
